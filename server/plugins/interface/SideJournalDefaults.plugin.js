...
const QUEST_LIST_ENTRY_LIST_UID = (INTERFACE_QUEST_LIST_ID << 16) | 7;
const QUEST_LIST_ENTRY_MAX_SLOT = 199;
const QUEST_LIST_ENTRY_EVENT_FLAGS = 0x7e;
const DIARY_LIST_TASKBOX_UID = (INTERFACE_ACHIEVEMENT_DIARY_ID << 16) | 2;
const DIARY_LIST_ENTRY_MAX_SLOT = 11;
const DIARY_LIST_ENTRY_EVENT_FLAGS = 0x6;
...
function mountSideJournalContent(player, groupId, tabIndex) {
  ...
  } else if (groupId === INTERFACE_ACHIEVEMENT_DIARY_ID) {
    player.getPacketSender().sendInterfaceFlagsRange(
