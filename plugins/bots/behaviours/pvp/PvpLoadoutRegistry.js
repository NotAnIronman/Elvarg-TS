...
const PVP_LOADOUTS = Object.freeze({
  edge_main_melee: freezeLoadout({
    ...
    weaponFamilies: ["whip", "dds", "dscim", "ags"],
    armorFamilies: ["fighter", "barrows", "rune"],
    archetypes: ["main_whip", "zerker_whip", "zerker_dscim"],
  ...
  edge_ranged_melee: freezeLoadout({
    ...
    armorFamilies: ["dhide", "fighter", "rune"],
    archetypes: ["msb_gmaul", "rcb_dds", "msb_dds"],
  ...
  deep_wild_hybrid: freezeLoadout({
    ...
    armorFamilies: ["mystic", "dhide", "ahrim"],
    archetypes: ["ancients_hybrid", "tribrid_main", "nh_pure"],
  ...
  rusher: freezeLoadout({
    ...
    label: "Rusher",
    tags: ["rush", "spec", "edge"],
    weaponFamilies: ["dds", "gmaul", "ags"],
    armorFamilies: ["light", "fighter", "mixed"],
    archetypes: ["gmaul_rusher", "dds_rusher", "obby_rusher"],
