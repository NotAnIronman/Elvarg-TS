export enum Opcodes {
    ...
    CC_CLEAROPS = 1307,
    /** Pops 1 int: forces left-click execution of the op without opening the menu */
    CC_SETOPFORCELEFTCLICK = 1308,
    /** Pops 1 int and discards it (stubbed in the client) */
    CC_OP1309 = 1309,
    /** Pops 1 int (op index 1-10): clears submenu entries for that op */
    CC_CLEAROPSUBMENU = 1310,
    /** Pops string + 2 ints (subIndex, opIndex): sets submenuActions[op][sub] */
    CC_SETOPSUBMENU = 1311,
    /** Pops 1 int: sets target priority (-1 resets to 4; 1-32 stores value-1) */
    ...
    IF_CLEAROPS = 2307,
    IF_SETOPFORCELEFTCLICK = 2308,
    IF_OP2309 = 2309,
    IF_CLEAROPSUBMENU = 2310,
    ...
    OC_WEIGHT = 4217,
    OC_EXAMINE = 4218,
    OC_ISUBOP = 4222, // oc_isubop(obj, opIndex, subIndex) -> string
    ...
    MINIMENU_SETLEFTCLICKOPENS = 7463,
    ...
    LOOTTRACKER_IGNORESOURCEADD = 7622,
    LOOTTRACKER_IGNORESOURCEDEL = 7623,
    LOOTTRACKER_IGNORESOURCECOUNT = 7625,
    LOOTTRACKER_IGNORESOURCEGET = 7626,
