...
class PlayerOptionPacketListener {
    // public static attack(player: Player, packet: Packet) {
    static attack(player, packet) {
    ...
    static option1(player, packet) {
        let id = packet.readShort() & 0xffff;
