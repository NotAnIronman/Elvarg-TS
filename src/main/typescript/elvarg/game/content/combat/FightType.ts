...
export class FightType {
    ...
    public static DRAGON_DAGGER_STAB = new FightType(376, 43, 0, ATTACK_STAB, FightStyle.ACCURATE, Sound.WEAPON_DRAGON_DAGGER_STAB)
    public static DRAGON_DAGGER_LUNGE = new FightType(376, 43, 1, ATTACK_STAB, FightStyle.AGGRESSIVE, Sound.WEAPON_DRAGON_DAGGER_STAB)
    public static DRAGON_DAGGER_SLASH = new FightType(377, 43, 2, ATTACK_STAB, FightStyle.AGGRESSIVE, Sound.WEAPON_DRAGON_DAGGER_STAB)
    public static DRAGON_DAGGER_BLOCK = new FightType(376, 43, 3, ATTACK_STAB, FightStyle.DEFENSIVE, Sound.WEAPON_DRAGON_DAGGER_STAB)
