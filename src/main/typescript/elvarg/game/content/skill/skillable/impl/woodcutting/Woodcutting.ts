...
export class Tree {
    public static readonly NORMAL = new Tree(
        1,
        25,
        1511,
    ...
    public static readonly ACHEY = new Tree(
        1,
        25,
        2862,
        [2023],
    ...
    public static readonly OAK = new Tree(
        15,
        38,
        1521,
        [1281, 3037, 9734, 1751],
    ...
    public static readonly WILLOW = new Tree(
        30,
        68,
        1519,
    ...
    public static readonly TEAK = new Tree(
        35,
        85,
        6333,
        [9036],
    ...
    public static readonly DRAMEN = new Tree(
        36,
        88,
        771,
        [1292],
    ...
    public static readonly MAPLE = new Tree(
        45,
        100,
        1517,
        [1759, 4674],
    ...
    public static readonly MAHOGANY = new Tree(
        50,
        125,
        6332,
        [9034],
    ...
    public static readonly YEW = new Tree(
        60,
        175,
        1515,
        [1309, 1753],
    ...
    public static readonly MAGIC = new Tree(
        75,
        250,
        1513,
        [1761],
    ...
    public static readonly REDWOOD = new Tree(
        90,
        380,
        19669,
        [],
    ...
    private readonly xpReward: number;
    private readonly logId: number;
    private readonly cycles: number;
    private readonly respawnTimer: number;
