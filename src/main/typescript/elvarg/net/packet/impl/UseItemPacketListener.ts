...
export class UseItemPacketListener implements PacketExecutor {
  ...
  private static itemOnItem(player: any, packet: Packet) {
  ...
  public static itemOnNpc(player: any, packet: Packet) {
  ...
  private static itemOnObject(player: any, packet: Packet) {
  ...
  private static itemOnPlayer(player: any, packet: Packet) {
  ...
  private static itemOnGroundItem(player: any, packet: Packet) {
